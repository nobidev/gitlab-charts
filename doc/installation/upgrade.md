...
- Gitaly on Kubernetes supports zero-downtime upgrades [through client retries](https://docs.gitlab.com/administration/settings/gitaly_timeouts/#gitaly-client-retries). 
