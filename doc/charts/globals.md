...
- `global.registry.enabled` controls the **GitLab&nbsp;↔&nbsp;Registry integration**: whether the
...
To fully disable Container Registry features, set `global.registry.enabled: false`. Leaving the
