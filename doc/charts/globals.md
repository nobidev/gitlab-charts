...
- `address`: (optional) A full URI for the Gitaly service (e.g., `dns://8.8.8.8:53/gitaly.consul.internal`). When specified, this takes precedence over `hostname` and `port`.
