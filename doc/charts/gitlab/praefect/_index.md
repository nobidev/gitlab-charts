...
`defaultReplicationFactor` can be configured on each virtual storages. For more information, see [configure replication-factor](https://docs.gitlab.com/administration/gitaly/praefect/configure/#configure-replication-factor).
...
| `extraVolumeMounts`                                      |                                                   | List of extra volume mounts to create |
