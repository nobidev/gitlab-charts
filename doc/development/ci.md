...
|--------------------|--------------------------------------|-------------|
| `LIMIT_TO`         | `""`                                 | Limit pipeline execution to a specific logical block. Available blocks: `gke`, `k3d_version`, `k3d_version_arm64`. Empty value implies absence of limits - i.e. all components shall be considered for execution. |
