...
# Optional: paste your EE license activation code here so the chart's
# EE-feature scenarios don't get skipped by gitlab-qa smoke. The Secret name
# matches the scripts/ci/values/gitlab-chart/ci-license.values.yaml template.
# export QA_EE_ACTIVATION_CODE="<activation-code>"
```
