...
command indexed by the [Kubernetes object `kind`](https://kubernetes.io/docs/concepts/overview/working-with-objects/) and the object name (`metadata.name`). This indexed
