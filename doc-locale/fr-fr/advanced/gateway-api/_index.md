...
> [!warning] Les workspaces GitLab ne prennent pas encore en charge le TLS interne. Si vous utilisez des workspaces, n'activez pas le TLS interne pour GitLab Relay car cela entraînera des erreurs de protocole et TLS.
