...
> [!note]
> GitLab ne prétend pas fournir une infrastructure PKI de haute qualité, ni des autorités de certification.
...
> [!note]
> Ce script _ne préserve pas_ la clé privée de la CA. Il s'agit d'un assistant de preuve de concept, et _n'est pas destiné à un usage en production_.
