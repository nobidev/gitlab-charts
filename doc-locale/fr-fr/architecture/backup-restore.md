...
> [!note] Si la restauration échoue, l'utilisateur devra revenir à une sauvegarde précédente en utilisant les données du répertoire `tmp` du bucket de sauvegarde, ce qui est un processus manuel.
