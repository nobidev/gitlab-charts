...
| `opensshd.supplemental_config`                           |                                                         | Configuration supplémentaire, ajoutée à `sshd_config`. Alignement strict avec la [page de manuel](https://manpages.debian.org/trixie/openssh-server/sshd_config.5.en.html) |
