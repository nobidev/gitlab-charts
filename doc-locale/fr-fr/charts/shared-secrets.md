...
> [!note]
> Si vous désactivez ce job, vous **devez** créer manuellement tous les secrets et fournir tout le contenu secret nécessaire. Consultez [installation/secrets](../installation/secrets.md#manual-secret-creation-optional) pour plus de détails.
