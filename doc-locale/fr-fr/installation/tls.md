...
> [!note]
> Si vous configurez votre instance GitLab pour communiquer avec d'autres services, il peut être nécessaire de [fournir les chaînes de certificats](../charts/globals.md#custom-certificate-authorities) pour ces services à GitLab via le chart Helm également.
