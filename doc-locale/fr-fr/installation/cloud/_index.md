...
> [!warning] Les [images de conteneurs GitLab](../_index.md#container-images) peuvent être déployées sur les architectures x86-64 et ARM64. Les images validées FIPS sont uniquement disponibles pour x86-64. Consultez le [ticket 2285](https://gitlab.com/gitlab-org/build/CNG/-/issues/2285) pour connaître le statut FIPS d'ARM64.
