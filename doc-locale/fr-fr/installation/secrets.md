...
> [!warning] Cette méthode n'ajoutera une licence qu'au moment de l'installation. Utilisez la zone d'administration dans l'interface utilisateur web pour renouveler ou mettre à niveau les licences.
...
> [!note] Utilisez le nom du `Secret`, et non le _mot de passe réel_, lors de la configuration de la propriété Helm.
