...
> [!note]
> 이 작업을 사용 안 함으로 설정하면 모든 비밀정보를 **must** 수동으로 생성하고 필요한 모든 비밀정보 콘텐츠를 제공해야 합니다. 자세한 내용은 [installation/secrets](../installation/secrets.md#manual-secret-creation-optional)를 참조하세요.
