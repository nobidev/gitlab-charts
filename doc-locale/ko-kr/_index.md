...
> [!note] GitLab Helm 차트는 프로덕션 배포를 위해 외부 PostgreSQL, Redis 및 객체 저장소가 필요합니다. 이러한 서비스의 번들 버전은 평가 목적으로만 포함됩니다. 프로덕션의 경우 [클라우드 네이티브 하이브리드 참조 아키텍처](installation/_index.md#use-the-reference-architectures)를 따르세요.
