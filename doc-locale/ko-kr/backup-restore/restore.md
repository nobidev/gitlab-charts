...
> [!note] 복원 중에 백업 tarball을 디스크에 추출해야 합니다. 이는 Toolbox 포드에 필요한 크기의 디스크가 있어야 함을 의미합니다. 자세한 내용 및 구성은 [Toolbox 설명서](../charts/gitlab/toolbox/_index.md#persistence-configuration)를 참조하세요.
