...
> [!warning] 이 명령어들은 Kubernetes 구성요소를 **변경하거나 손상시킬 수** 있으므로 자신의 책임 하에 사용하세요.
...
> [!warning] 이 작업은 정기적으로 수행해야 할 것이 아닙니다. 자신의 책임 하에 사용하세요.
...
> [!note] `toolbox` Pod를 사용하여 변경한 내용은 Pod가 다시 시작되면 유지되지 않습니다. 이들은 컨테이너 작동 기간에만 존재합니다.
