...
{{- .Values.gatewayApiProvider.standard.class.name -}}
{{- end -}}
...
{{- $redirect := and .Values.global.gatewayApi.httpToHttpsRedirect (eq (upper .Values.gatewayApiProvider.standard.gateway.protocol) "HTTPS") -}}
...
{{- $httpsProtocol := eq (upper .Values.gatewayApiProvider.standard.gateway.protocol) "HTTPS" -}}
