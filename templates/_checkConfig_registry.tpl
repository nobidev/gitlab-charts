...
{{- if $.Values.registry.database.loadBalancing.enabled }}
  {{- $dbEnabled := include "registry.database.isEnabled" $ -}}
  {{- if ne $dbEnabled "true" }}
registry:
...
{{-   $dbEnabled := include "registry.database.isEnabled" $ -}}
{{-   if and $.Values.registry.redis.cache.enabled (ne $dbEnabled "true") }}
registry:
...
{{-     end -}}
{{- end -}}
{{-   if and (eq $dbEnabled "true") $.Values.registry.redis.cache.enabled $.Values.registry.redis.cache.sentinels}}
